...
datasetFile = "https://storage.googleapis.com/download.tensorflow.org/example_images/flower_photos.tgz"
datsetLabelFile = ""
...
#This is where all the parameters are
x_pixels,y_pixels = 400, 400

num_epochs = 8
# Num labels I think definitely needs to be adaptive
num_labels = 1
batch_size = 10

# This model takes in an input based on the video size and outputs based on the number of different labels
# in the dataset
def createModel(x_pixels, y_pixels, num_labels):
...
def trainModel(model, num_epochs, train_dataset, validation_dataset):
    history = model.fit(
        train_dataset,
